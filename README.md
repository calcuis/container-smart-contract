...
*this contract (backend) and the frontend code are for education/demonstration purpose(s); don't pay anything for mainnet; still buggie; learn it with testnet(s) is recommended.
